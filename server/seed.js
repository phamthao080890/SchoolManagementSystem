...
async function seedDatabase() {
    try {
        ...
        const materialSlide = await CourseMaterial.create({
            ...
            type: 'lecture',
            fileUrl: `${process.env.API_BASE_URL || 'http://localhost:5000'}/uploads/chuong1_tongquan.pdf`
        });
        ...
        const materialAssignment = await CourseMaterial.create({
            ...
            type: 'assignment',
            fileUrl: `${process.env.API_BASE_URL || 'http://localhost:5000'}/uploads/baitap1_yeucau.pdf`,
        ...
        await AssignmentSubmission.create({
            ...
            fileUrl: `${process.env.API_BASE_URL || 'http://localhost:5000'}/uploads/B24DCCN001_baitap1.zip`,
        ...
        await AssignmentSubmission.create({
            ...
            fileUrl: `${process.env.API_BASE_URL || 'http://localhost:5000'}/uploads/B24DCCN002_baitap1.zip`,
